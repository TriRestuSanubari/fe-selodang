        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-foreground-500 text-sm leading-relaxed">
              Layanan Resmi Pemesanan Keripik Cabe Selodang, UMKM lokal yang memproduksi camilan 
              keripik cabe berkualitas tinggi dengan cita rasa autentik. 
              Pesan Sekarang!
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-foreground-500">restusanubari2@gmail.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <FaPhone className="w-4 h-4 text-success" />
                <span className="text-foreground-500">0852-7170-1932</span>
              </div>
        ...
        <div className="border-t border-gray-200 dark:border-y-zinc-900 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-foreground">
              © 2025 KeripikCabe. Semua hak cipta dilindungi.
            </p>
