              ...
              <ModalBody className="space-y-6">
                ...
                <section>
                  ...
                  <p className="text-foreground-500 leading-relaxed mb-3">
                    Kami menyediakan platform e-commerce untuk pembelian produk
                    kami yang berkualitas tinggi. Layanan kami meliputi:
                  </p>
                  <ul className="list-disc list-inside text-foreground-500 space-y-1 ml-4">
                    <li>Penjualan keripik dan eksrim</li>
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside text-foreground-500 space-y-1 ml-4">
                    ...
                    <li>
                      Produk tidak dapat dikembalikan kecuali ada
                      kerusakan
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <div className="mt-3 space-y-1 text-foreground-500 ml-4">
                    <p>- Email: restusanubari2@gmail.com</p>
                    <p>- Telepon: +62 852-7170-1932</p>
                    <p>- Alamat: Jl. Stadion, Duri Riau</p>
                  </div>
                </section>
