    ...
    >
      ...
      <CardBody className="p-2">
        <div className="space-y-2">
          ...
          <button
            className="w-full mt-3 text-white bg-success hover:bg-success-400 transition-colors duration-300 rounded-lg cursor-pointer flex items-center justify-center py-2 px-1 lg:px-4 gap-1 text-xs lg:text-sm disabled:bg-success-400 shrink-0 text-center"
